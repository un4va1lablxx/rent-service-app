...
@Table(name = "ratings", uniqueConstraints = {
        @UniqueConstraint(name = "uk_ratings_contract_reviewer", columnNames = {"contract_id", "from_user_id"})
}, indexes = {
        @Index(name = "idx_ratings_contract", columnList = "contract_id"),
        @Index(name = "idx_ratings_to_user", columnList = "to_user_id"),
        @Index(name = "idx_ratings_from_user", columnList = "from_user_id"),
        @Index(name = "idx_ratings_role", columnList = "role_of_reviewer")
})
@Data
@NoArgsConstructor
@AllArgsConstructor
